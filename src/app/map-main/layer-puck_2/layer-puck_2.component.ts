...
export class LayerPuckComponent_2 implements AfterViewInit {
  ...
  @ViewChildren('iconContainer_2') icons;
  @ViewChildren('slideIconContainer_2') slideIcons;
  @ViewChild('iconContainer_2', { static: false }) iconContainer;
  @ViewChild('layerPuckContainer_2', { static: false }) puckContainer;
