...
@Component({
  selector: 'app-layer-puck_3',
  templateUrl: './layer-puck_3.component.html',
  styleUrls: ['./layer-puck_3.component.css']
})
export class LayerPuckComponent_3 implements AfterViewInit {

  @ViewChildren('iconContainer_3') icons;
  @ViewChildren('slideIconContainer_3') slideIcons;
  @ViewChild('iconContainer_3', { static: false }) iconContainer;
  @ViewChild('layerPuckContainer_3', { static: false }) puckContainer;
