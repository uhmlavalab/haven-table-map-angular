...
import { MapLayer, MapFeature, Scenario } from '@app/plan';
import { WindowService } from '@app/window';
import { Message } from 'ngx-multi-window';
...
export class SecondScreenComponent implements AfterViewInit, OnDestroy {
  ...
  constructor(private windowService: WindowService, private detectorRef: ChangeDetectorRef) {
  }

  ngAfterViewInit(): void {

    this.windowService.getMultiWindowService().onMessage().subscribe((value: Message) => {
