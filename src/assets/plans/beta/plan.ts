    ...
    mapLayers: [
      {
        ...
        active: false,
        included: true,
        iconPath: 'assets/plans/beta/images/icons/transmission-icon.png',
        secondScreenImagePath: 'assets/plans/beta/images/second-screen-images/layer-images/transmission.jpg',
        ...
        filePath: 'assets/plans/beta/layers/transmission.json',
        parcels: [],
      ...
      },
      {
        ...
        active: false,
        included: true,
        iconPath: 'assets/plans/beta/images/icons/dod-icon.png',
        secondScreenImagePath: 'assets/plans/beta/images/second-screen-images/layer-images/dod.jpg',
        secondScreenText: 'Slide the Layer Puck to add or remove this layer.',
        fillColor: mapLayerColors.Dod.fill,
        borderColor: mapLayerColors.Dod.border,
        borderWidth: 1,
        legendColor: mapLayerColors.Dod.fill,
        filePath: 'assets/plans/beta/layers/government.json',
        parcels: [],
        setupFunction(planService: PlanService) {
          const colors = {
      ...
      },
      {
        ...
        active: false,
        included: true,
        iconPath: 'assets/plans/beta/images/icons/solar-icon.png',
        secondScreenImagePath: 'assets/plans/beta/images/second-screen-images/layer-images/solar.jpg',
        secondScreenText: 'Slide the Layer Puck to add or remove this layer.',
        fillColor: mapLayerColors.Solar.fill,
        borderColor: mapLayerColors.Solar.border,
        borderWidth: 0.5,
        legendColor: mapLayerColors.Solar.fill,
        filePath: 'assets/plans/beta/layers/solar.json',
        parcels: [],
        setupFunction(planService: PlanService) {
      ...
      },
      {
        ...
        active: false,
        included: true,
        iconPath: 'assets/plans/beta/images/icons/wind-icon.png',
        secondScreenImagePath: 'assets/plans/beta/images/second-screen-images/layer-images/wind.jpg',
        secondScreenText: 'Slide the Layer Puck to add or remove this layer.',
        fillColor: mapLayerColors.Wind.fill,
        borderColor: mapLayerColors.Wind.border,
        borderWidth: .05,
        legendColor: mapLayerColors.Wind.fill,
        filePath: 'assets/plans/beta/layers/wind.json',
        parcels: [],
        setupFunction(planService: PlanService) {
      ...
      },
      {
        ...
        active: false,
        included: true,
        iconPath: 'assets/plans/beta/images/icons/agriculture-icon.png',
        secondScreenImagePath: 'assets/plans/beta/images/second-screen-images/layer-images/agriculture.jpg',
        secondScreenText: 'Slide the Layer Puck to add or remove this layer.',
        ...
        filePath: 'assets/plans/beta/layers/agriculture.json',
        parcels: [],
        setupFunction(planService: PlanService) {
          const colors = {
            A: '#267300' + 'aa',
