...
@Component({
  selector: 'app-map-layer-legend',
  templateUrl: './map-layer-legend.component.html',
  styleUrls: ['./map-layer-legend.component.css']
})
export class MapLayerLegendComponent implements AfterViewInit {
